...
export function CareerTimeline({
    ...
    return (
        <Accordion
            type="single"
            collapsible
            className="relative mt-10 space-y-4 before:absolute before:top-4 before:bottom-4 before:left-[1.15rem] before:w-px before:bg-linear-to-b before:from-violet-500/60 before:via-violet-500/20 before:to-transparent sm:before:left-[1.4rem]"
        >
                                ...
                                <div className="min-w-0 flex-1 pr-4">
                                    <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                                        ...
                                        <span className="flex shrink-0 items-center gap-1.5 font-mono text-xs text-violet-300">
                                            ...
                                            {monthYear(experience.startedAt, locale)} —{" "}
                                            {experience.current
                                                ? currentLabel
                                                : experience.finishedAt
                                                  ? monthYear(experience.finishedAt, locale)
                                                  : currentLabel}
                                        </span>
                                    </div>
                                    ...
                                    <div className="mt-5 flex flex-wrap items-center gap-4 text-xs text-zinc-500">
                                        ...
                                        {experience.companyUrl ? (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noreferrer"
                                                className="flex items-center gap-1.5 text-violet-300 transition hover:text-violet-200"
                                            >
                                                {experience.company}
