            ...
            <div className="grid gap-6 xl:grid-cols-2">
                <Card className="border-violet-500/10 bg-zinc-900/70 ring-0">
                    <CardHeader className="border-b border-white/5">
                        ...
                        <CardDescription className="text-zinc-500">Dados exibidos na área pública e nos botões de contato.</CardDescription>
                    </CardHeader>
                    <CardContent className="grid gap-5 sm:grid-cols-2">
                        ...
                        />
                        <TextField label="Localização" name="location" defaultValue={values.location} errors={state.fieldErrors?.location} />
                        <TextField label="GitHub" name="githubUrl" type="url" defaultValue={values.githubUrl} errors={state.fieldErrors?.githubUrl} />
                        <TextField label="LinkedIn" name="linkedinUrl" type="url" defaultValue={values.linkedinUrl} errors={state.fieldErrors?.linkedinUrl} />
                        <TextField
                ...
                <div>
                    <Card className="border-violet-500/10 bg-zinc-900/70 ring-0">
                        <CardHeader className="border-b border-white/5">
                            ...
                            <CardDescription className="text-zinc-500">Cada idioma pode baixar um PDF diferente da sua biblioteca do OneDrive.</CardDescription>
                        </CardHeader>
                        <CardContent className="grid gap-5 ">
                            ...
                            />
                            {pdfs.length === 0 ? (
                                <p className="text-xs text-amber-300 sm:col-span-2">Envie os PDFs na Biblioteca de mídia antes de vinculá-los.</p>
                            ) : null}
                            <MediaSelect
                            ...
                            />
                            {images.length === 0 ? (
                                <p className="text-xs text-amber-300">Envie uma imagem na Biblioteca de mídia para poder selecioná-la aqui.</p>
                            ) : null}
                        </CardContent>
                    </Card>
