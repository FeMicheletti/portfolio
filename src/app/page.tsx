...
const copy = {
    PT_BR: {
        ...
        aboutDescription:
            "Desenvolvedor Full-Stack desde 2020, atuo da descoberta do problema à entrega e evolução do produto. Minha trajetória combina desenvolvimento, decisões de arquitetura e liderança de times multidisciplinares.",
        currentRole: "Atual",
    ...
    EN_US: {
        ...
        aboutDescription:
            "A Full-Stack Developer since 2020, I work from problem discovery through product delivery and evolution. My career combines hands-on development, architecture decisions and multidisciplinary team leadership.",
        currentRole: "Present",
...
export default async function Home({ searchParams }: { searchParams: Promise<{ lang?: string }> }) {
    ...
    return (
        <AnalyticsProvider locale={locale}>
            ...
            <div
                lang={locale === "EN_US" ? "en-US" : "pt-BR"}
                className="dark min-h-screen overflow-x-hidden bg-zinc-950 text-zinc-100 selection:bg-violet-500/30"
            >
                ...
                <main className="relative">
                    <section id="home" className="relative isolate min-h-svh overflow-hidden border-b border-white/5">
                        <Image
                            ...
                            priority
                            sizes="100vw"
                            unoptimized={Boolean(settings?.heroMediaId)}
                            className="absolute inset-0 -z-30 object-cover object-[62%_center] sm:object-center"
                        />
                                ...
                                <div className="relative overflow-hidden rounded-[2rem] border border-white/15 bg-zinc-950/72 p-6 shadow-2xl shadow-black/60 backdrop-blur-xl sm:p-8">
                                    ...
                                    <div className="space-y-4 py-7 font-mono text-sm leading-7 sm:text-base sm:leading-8">
                                        ...
                                        <p className="pl-5 sm:pl-8">
                                            ...
                                            <span className="text-emerald-300">&quot;{settings?.location || content.location}&quot;</span>
                                        </p>
                                        <p>
                                ...
                                <div className="mt-4 grid gap-2 rounded-2xl border border-white/10 bg-zinc-950/65 p-2 shadow-xl shadow-black/30 backdrop-blur-xl sm:grid-cols-2">
                                    {resume ? (
                                        <Button
                                            asChild
                                            size="lg"
                                            className="group h-14 justify-start rounded-xl border border-violet-400/20 bg-violet-500/10 px-3 text-white shadow-none transition-all hover:border-violet-400/40 hover:bg-violet-500/20"
                                        >
                                            <AnalyticsLink
                                                eventType="RESUME_DOWNLOAD"
                                                href={`/api/media/${resume.mediaId}?download=1&filename=Felipe-Micheletti-CV.pdf`}
                                            >
                                        ...
                                        <Button
                                            size="lg"
                                            disabled
                                            title={content.resumeUnavailable}
                                            className="h-14 justify-start rounded-xl border border-white/5 bg-white/3 px-3 text-zinc-500 disabled:opacity-60"
                                        >
                                    ...
                                    <Button
                                        ...
                                        size="lg"
                                        variant="ghost"
                                        className="group h-14 justify-start rounded-xl border border-transparent px-3 text-white transition-all hover:border-sky-400/20 hover:bg-sky-400/10 hover:text-white"
                                    >
                            ...
                            <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
                                ...
                                {experiences.length ? (
                                    <CareerTimeline
                                        ...
                                        locale={locale}
                                        currentLabel={content.currentRole}
                                        openLabel={content.openExperience}
                                    />
                                ) : null}
                            </div>
                        </div>
                                    ...
                                    {projects.map((project, index) => {
                                        ...
                                        return (
                                            <AnalyticsProjectView
                                                ...
                                                className="group min-w-[320px] snap-start overflow-hidden rounded-2xl border border-white/8 bg-zinc-950/60 transition duration-300 hover:-translate-y-1 hover:border-violet-500/25 hover:shadow-2xl hover:shadow-violet-950/20 sm:min-w-95 lg:min-w-105"
                                            >
                                                ...
                                                <div className="p-6 sm:p-7">
                                                    ...
                                                    <div className="mt-5 flex flex-wrap gap-2">
                                                        {project.technologies.map(({ technology }) => (
                                                            <span
                                                                ...
                                                                style={technology.color ? { borderColor: `${technology.color}35` } : undefined}
                                                            >
                                                                {technology.name}
                                                            </span>
                                                        ))}
                                                    ...
                                                    <Link
                                                        href={`/projetos/${project.slug}${locale === "EN_US" ? "?lang=en" : ""}`}
                                                        className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-violet-300 hover:text-violet-200"
                                                    >
                                                        {content.viewCase}
                                            ...
                                            {category.technologies.map((technology) => (
                                                ...
                                                >
                                                    <span
                                                        ...
                                                        style={{ color: technology.color || "#a78bfa" }}
                                                    >
                                ...
                                <div className="flex justify-center gap-2">
                                    {[
                                        ...
                                        ...(settings?.whatsappUrl
                                            ? [{ label: "WhatsApp", href: settings.whatsappUrl, icon: MessageCircle, eventType: "WHATSAPP_CLICK" as const }]
                                            : []),
