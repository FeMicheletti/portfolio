			...
			<section className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
				<div>
					...
					<p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-400">
						Acompanhe o conteúdo e as interações de quem visita seu trabalho.
					</p>
				</div>
			...
			<section className="grid gap-4 xl:grid-cols-[1.65fr_1fr]">
				...
				<Card className="border-violet-500/10 bg-linear-to-b from-violet-950/40 to-zinc-900/70 shadow-lg shadow-black/10 ring-0">
					<CardHeader>
						...
						<CardDescription className="text-zinc-500">
							Entenda como as pessoas encontram e exploram seu portfólio.
						</CardDescription>
					</CardHeader>
					<CardContent>
						<p className="text-sm leading-6 text-zinc-400">Consulte tendências diárias, dispositivos, origens, downloads e os projetos que mais despertam interesse.</p>
						<Link href="/admin/metricas" className="mt-6 inline-flex items-center gap-2 rounded-lg bg-violet-600 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-violet-500">
