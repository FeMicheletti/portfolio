...
export default async function SettingsPage() {
	...
	const resumeByLocale = new Map(
		resumes.map((resume) => [resume.locale, resume.mediaId]),
	);
		...
		<div className="space-y-6">
			<div>
				...
				<p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-400">
					Atualize os dados gerais, o hero e os currículos sem precisar alterar
					o código.
				</p>
			</div>
			...
			<SiteSettingsForm
				...
				values={{
					...
					linkedinUrl:
						...
						"https://www.linkedin.com/in/felipe-micheletti",
